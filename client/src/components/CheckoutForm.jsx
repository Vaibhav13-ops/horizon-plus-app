...
const CheckoutForm = ({ consultantId, timeSlot }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const return_url = `${window.location.origin}/booking-success?consultant_id=${consultantId}&time_slot=${encodeURIComponent(timeSlot)}`;
